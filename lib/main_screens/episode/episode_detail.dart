...
import 'package:zeus/main_screens/episode/episode_state.dart';
import 'package:zeus/main_screens/episode/potrait_video.dart';
import 'package:zeus/main_screens/episode/video_cubit.dart';
...
class EpisodeDetail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (create)=>VideoCubit(episodeId: episodeModal.episodeId,lastWatchedPosition: lastWatchedPosition)..initVideoPlayer(episodeModal.video)),
