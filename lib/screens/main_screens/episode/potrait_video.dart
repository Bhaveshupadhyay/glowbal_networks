...
import 'package:zeus/screens/subscription/subscription_renew.dart';
                            ...
                            child: AnimatedOpacity(
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Icon(
                                    Icons.close_sharp,size: 30.sp,color: Colors.white,),
                                ),
                              ),
                            ),
                          )
                  ...
                  Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: (){
                              context.read<VideoCubit>().initVideoPlayer(link: state.videoLink,isTrailer: false);
                            },
                            child: Container(
                              padding: EdgeInsets.symmetric(vertical: 5.h,horizontal: 10.w),
                              decoration: BoxDecoration(
