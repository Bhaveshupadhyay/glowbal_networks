...
import 'package:zeus/screens/profile/profile_cubit.dart';
import 'package:zeus/screens/profile/profile_state.dart';
                    ...
                    BlocBuilder<RegisterCubit,RegisterState>(
                        builder: (context,state){
                          if(state is RegisterLoading){
                            ...
                            WidgetsBinding.instance.addPostFrameCallback((_) {
                              Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (builder)=>const VerifyEmail(isCancelSub: false,)),(Route<dynamic> route) => false);
                            });
                          }
                          return InkWell(
                            onTap: () async {
